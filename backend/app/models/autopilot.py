...
class AutopilotSetting(Base):
    ...
    min_match_threshold = Column(Integer, default=75)
    ...
    require_user_approval = Column(Boolean, default=True)
    auto_tailor_resume = Column(Boolean, default=True)
    auto_prepare_screening = Column(Boolean, default=True)
    target_careers_json = Column(Text, nullable=True)
    location_preference = Column(String(255), default="India / Remote")
